...
alldata = dict()
alldata['1']=dict(nomor=1, nama="Sawamura Daichi", posisi="Wing Spiker")
alldata['2']=dict(nomor=2, nama="Azumane Asahi", posisi="Wing Spiker")
alldata['3']=dict(nomor=3, nama="Sugawara Koshi", posisi="Setter")
alldata['4']=dict(nomor=4, nama="Nishinoya Yu", posisi="Libero")
alldata['5']=dict(nomor=5, nama="Ryunosuke Tanaka", posisi="Wing Spiker")
alldata['6']=dict(nomor=6, nama="Ennoshita Chikara", posisi="Wing Spiker")
alldata['7']=dict(nomor=7, nama="Kinoshita Hisashi", posisi="wing Spiker")
alldata['8']=dict(nomor=8, nama="Narita Kazuhito", posisi="Middle Blocker")
alldata['9']=dict(nomor=9, nama="Kageyama Tobio", posisi="Setter")
alldata['10']=dict(nomor=10, nama="Hinata Shoyo", posisi="Middle Blocker")
alldata['11']=dict(nomor=11, nama="Tsukishima Kei", posisi="Middle Blocker")
alldata['12']=dict(nomor=12, nama="Yamaguchi Tadashi", posisi="Middle Blocker")
