...
alldata['6']=dict(nomor=6, nama="Tsukishima Kei", posisi="Middle Blocker")
alldata['7']=dict(nomor=9, nama="Kageyama Tobio", posisi="Setter")
alldata['8']=dict(nomor=10, nama="Hinata Shoyo", posisi="Middle Blocker")
